...
// measure-text-pixel-size-png.cpp
//
// To build on Linux:
//   cd /path/to/folder-of-this-file
//   mkdir -p build && cd build
//
//   g++ -g -Wall -o measure-text-pixel-size-png `pkg-config --cflags cairomm-1.0 pangomm-1.4` ../measure-text-pixel-size-png.cpp `pkg-config --libs cairomm-1.0 pangomm-1.4` && ./measure-text-pixel-size-png "../unicode-text.txt" "Noto Sans Mono CJK TC"
//
// To build on Mac:
//   g++ -g -Wall -std=c++17 -o measure-text-pixel-size-png `pkg-config --cflags cairomm-1.0 pangomm-1.4` ../measure-text-pixel-size-png.cpp `pkg-config --libs cairomm-1.0 pangomm-1.4`
...
int main(int argc, char** argv)
{
    ...
    std::string filename = "measure-text-pixel-size-png.png";
    int width = 600;
    int height = 800;
